...
public class DbInitializer
{
    ...
    {
        if (context.Activities.Any()) return;   // If no activities are in DbContext, return nothing
        ...
        context.Activities.AddRange(activities);    // EF track the facts that we updated
